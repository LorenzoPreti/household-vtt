...
class CardPersonaggioA extends StatefulWidget {
  final String docId;
  final Map<String, dynamic> dati;

  const CardPersonaggioA({
    super.key,
    required this.docId,
    required this.dati,
  });
  ...
  @override
  State<CardPersonaggioA> createState() => _CardPersonaggioAState();
}

class _CardPersonaggioAState extends State<CardPersonaggioA> {
              ...
              child: Container(
                ...
                child: LayoutBuilder(
                  builder: (context, constraints) {
                    ...
                    final double btnSize = cardWidth * 0.14;
                    final double iconSize = cardWidth * 0.07;
                    ...
                    return Stack(
                      ...
                      children: [
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Stress',
                                textAlign: TextAlign.center,
                                style: TextStyle(color: Colors.white, fontSize: cardWidth * 0.06, fontWeight: FontWeight.bold, letterSpacing: 1.2),
                              ),
                              ...
                              FittedBox(
                                ...
                                child: Row(
                                  ...
                                  children: List.generate(12, (index) {
                                    ...
                                    return MouseRegion(
                                      onEnter: (_) => setState(() => _hoveredStressIndex = valoreQuadratino),
                                      onExit: (_) => setState(() => _hoveredStressIndex = 0),
                                      child: GestureDetector(
                                        behavior: HitTestBehavior.opaque,
                                        onTap: () {
                                          int nuovoStress = valoreQuadratino;
                                          if (stressAttuale == valoreQuadratino) {
                                            nuovoStress = valoreQuadratino - 1;
                                          }
                                          _aggiornaStressOnline(nuovoStress);
                                        },
                                        child: Padding(
                        ...
                        // 4. BOTTONE PERSONA — scala con la card
                        Positioned(
                          top: cardWidth * 0.04,
                          left: cardWidth * 0.04,
                          child: SizedBox(
                            ...
                            child: IconButton(
                              onPressed: () {
                                Navigator.pushNamed(context, '/scheda', arguments: {
                                  "docId": widget.docId
                                });
                              },
  ...
  Widget _buildBottoneAssoOnline({
    ...
    return MouseRegion(
      onEnter: (_) => setState(() => _hoveredAssoHashCode = semeHash),
      onExit: (_) => setState(() => _hoveredAssoHashCode = 0),
      child: GestureDetector(
        behavior: HitTestBehavior.opaque,
        onTap: () => _aggiornaAssoOnline(seme, isAttivo),
        child: SizedBox(
          width: size,
          height: size,
          child: ClipRect(
